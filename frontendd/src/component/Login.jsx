...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axios.post("http://localhost:3000/api/loginuser", formData);
  ...
  return (
    <div
      style={{
        backgroundImage: `url('https://img.freepik.com/free-photo/education-day-arrangement-table-with-copy-space_23-2148721266.jpg?semt=ais_hybrid&w=740')`,
